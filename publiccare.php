      ...
      <div class="container">
        ...
        <div class="tab-content" data-aos="fade-up">
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> <n2 >HARYANA CONFIRMED<h2>
                  <n2 id="dc"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>HARYANA RECOVERED<h2>
                  <n2 id="dr"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>HARYANA DEATHS<h2>
                  <n2 id="dd"><h2></li>
                </ul>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>Clinics  & Testing centers in Haryana</h3>
                
                <p class="font-italic">
                  List of government approved testing centers
                <ul>
                  <li><i class="ri-check-double-line"></i>BPS Govt. Medical College,Sonipat</li>
                  <li><i class="ri-check-double-line"></i> Modern Diagnostic & Research Centre-Lab,363-364/4, Jawahar Nagar,Gurgaon</li>
                  <li><i class="ri-check-double-line"></i>Pathkind Diagnostics Pvt Ltd,Plot 55-56, Phase 4,Udyog Vihar,Sec-118,Gurgaon</li>
                  <li><i class="ri-check-double-line"></i> SRL Limited,GP26,Sector 18,Gurugram </li>
                  <li><i class="ri-check-double-line"></i> Strand Life Sciences,A-17,Sector 34,Gurugram</li>
                </ul>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
...
Array.prototype.sum = function (prop) {
    ...
    var DelhiConfirmed = covid_data[13].districtData.sum("confirmed");
    document.getElementById("dc").innerHTML = DelhiConfirmed
    var DelhiDeceased = covid_data[13].districtData.sum("deceased");
    document.getElementById("dd").innerHTML = DelhiDeceased
        var DelhiRecovered = covid_data[13].districtData.sum("deceased");
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                    <?php
                                  $query = "SELECT * FROM healthcare WHERE state='haryana'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN HARYANA</h1>
  <br><br>
  <CENTER>
  <div ><a href="https://covidindia.org/haryana/#hospitals">
