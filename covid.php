        ...
        <div class="container">
          <div class="row">
            <div class="major-caousel js-carousel-1 owl-carousel">
              ...
              <div>
                <div class="media d-block media-custom text-center">
                  <a href="covid_ind/Tracker - Odisha/index.php"><img src="img/haryana/p1.png" alt="Image Placeholder" class="img-fluid"></a>
                  <br><br>
                  <div class="media-body" style="background-color: #121212">
                    <h3 class="mt-0 text-white">HARYANA ANALYSIS</h3>
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block">
                  ...
                  <span style="color: olive">34 Street Name, Haryana, India</span></li>
                <li class="d-block" ><span class="d-block text-grey"style="color: olive" >Phone:</span><span>+1 242 4942 290</span></li>
                <li class="d-block"><span class="d-block text-grey"style="color: olive">Email:</span><span>info@eharyana.com</span></li>
              </ul>
            </div>
          </div>
